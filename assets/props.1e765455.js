...
`,n(l.span,{className:"line"})]})})]}),`
`,n(h,{children:n(X,{})})]})}function nl(s={}){const{wrapper:l}=s.components||{};return l?n(l,Object.assign({},s,{children:n(N,s)})):N(s)}const el="2022/12/3 14:26:03",sl=`import { DemoBlock } from '@island/demo-block'
