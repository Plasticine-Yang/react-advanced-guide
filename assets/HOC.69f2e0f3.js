...
`]}),`
`,n(l.p,{children:"\u5E0C\u671B\u901A\u8FC7\u672C\u7BC7\u6587\u7AE0\u7684\u5B66\u4E60\uFF0C\u80FD\u5E2E\u52A9\u4F60\u89E3\u51B3\u5BF9 HOC \u7684\u7591\u60D1\uFF0C\u5982\u679C\u6709\u4EC0\u4E48\u522B\u7684\u95EE\u9898\u6B22\u8FCE\u5728\u8BC4\u8BBA\u533A\u7559\u8A00\uFF0C\u6211\u4F1A\u7B2C\u4E00\u65F6\u95F4\u56DE\u590D~"})]})}function _l(s={}){const{wrapper:l}=s.components||{};return l?n(l,Object.assign({},s,{children:n(w,s)})):w(s)}const Ll="2022/12/12 08:09:51",jl=`import { DemoBlock } from '@island/demo-block'
