import{jsx as e,jsxs as n,Fragment as E}from"react/jsx-runtime";import c,{useState as C}from"react";const A="_container_1199h_1",N={container:A},y=({children:s})=>e("div",{className:N.container,children:s}),u=["react","vue","vite","node"],d=({message:s="A Simple Component."})=>e("div",{children:s}),g=()=>{const[s,l]=C(!1),i=()=>e("div",{children:"Rendered by function."}),r=n(E,{children:[e("div",{children:"Hello World"}),e(c.Fragment,{children:e("div",{children:"\u{1F680}\u{1F680}\u{1F680}"})}),"This is a text element.",u.map(a=>n("div",{children:["[Array Element] -- let us learn ",a," "]},a)),e(d,{}),s?e(d,{message:"status: true"}):e(d,{message:"status: false"}),i(),e("button",{onClick:()=>l(!s),children:"toggle status"})]});return console.log("\u7ECF\u8FC7 React.createElement \u5904\u7406\u540E\u7684 el:",r),r},B=["react","vue","vite","node"],h=({message:s="A Simple Component."})=>e("div",{children:s}),f=()=>{const[s,l]=C(!1),i=()=>e("div",{children:"Rendered by function."}),r=n(E,{children:[e("div",{children:"Hello World"}),e(c.Fragment,{children:e("div",{children:"\u{1F680}\u{1F680}\u{1F680}"})}),"This is a text element.",B.map(o=>n("div",{children:["[Array Element] -- let us learn ",o," "]},o)),e(h,{}),s?e(h,{message:"status: true"}):e(h,{message:"status: false"}),i(),e("button",{onClick:()=>l(!s),children:"toggle status"})]}),{children:a}=r.props,p=c.Children.toArray(a);console.log("\u6241\u5E73\u5316\u540E\u7684 children:",p);const t=[];c.Children.forEach(p,o=>{c.isValidElement(o)&&t.push(o)});const m=c.createElement("div",{className:"last"},"last element");t.push(m);const F=c.cloneElement(r,{},...t);return console.log("\u589E\u5F3A\u53EF\u63A7\u6027\u540E\u7684 el:",F),F},x=void 0,R=[{id:"\u63D0\u51FA\u95EE\u9898",text:"\u63D0\u51FA\u95EE\u9898",depth:2},{id:"1-\u5E38\u7528\u7684\u5143\u7D20\u4F1A\u88AB-react-\u5904\u7406\u6210\u4EC0\u4E48",text:"1. \u5E38\u7528\u7684\u5143\u7D20\u4F1A\u88AB React \u5904\u7406\u6210\u4EC0\u4E48\uFF1F",depth:2},{id:"11-\u7ECF\u8FC7-babel-\u5904\u7406\u540E\u7684\u6837\u5B50",text:"1.1. \u7ECF\u8FC7 babel \u5904\u7406\u540E\u7684\u6837\u5B50",depth:3},{id:"12-\u7ECF\u8FC7-reactcreateelement-\u5904\u7406\u540E\u7684\u6837\u5B50",text:"1.2. \u7ECF\u8FC7 React.createElement \u5904\u7406\u540E\u7684\u6837\u5B50",depth:3},{id:"13-\u7ECF\u8FC7-react-\u5E95\u5C42\u8C03\u548C\u5904\u7406\u540E\u7684\u6837\u5B50",text:"1.3. \u7ECF\u8FC7 React \u5E95\u5C42\u8C03\u548C\u5904\u7406\u540E\u7684\u6837\u5B50",depth:3},{id:"131-fiber-tag",text:"1.3.1. Fiber Tag",depth:4},{id:"2-\u52A8\u624B\u5B9E\u8DF5----\u63D0\u9AD8\u7EC4\u4EF6\u53EF\u63A7\u6027",text:"2. \u52A8\u624B\u5B9E\u8DF5 -- \u63D0\u9AD8\u7EC4\u4EF6\u53EF\u63A7\u6027",depth:2},{id:"21-\u5C06-children-\u6241\u5E73\u5316\u628A\u91CC\u9762\u7684\u6570\u7EC4\u5143\u7D20\u62CD\u5E73",text:"2.1. \u5C06 children \u6241\u5E73\u5316\uFF0C\u628A\u91CC\u9762\u7684\u6570\u7EC4\u5143\u7D20\u62CD\u5E73",depth:3},{id:"22-\u53BB\u9664\u7EAF\u5B57\u7B26\u4E32\u5B50\u5143\u7D20",text:"2.2. \u53BB\u9664\u7EAF\u5B57\u7B26\u4E32\u5B50\u5143\u7D20",depth:3},{id:"23-\u5F80-children-\u7684\u672B\u5C3E\u63D2\u5165\u65B0\u5143\u7D20",text:"2.3. \u5F80 children \u7684\u672B\u5C3E\u63D2\u5165\u65B0\u5143\u7D20",depth:3},{id:"24-\u514B\u9686\u65B0\u7684\u5143\u7D20\u8282\u70B9\u5E76\u6E32\u67D3",text:"2.4. \u514B\u9686\u65B0\u7684\u5143\u7D20\u8282\u70B9\u5E76\u6E32\u67D3",depth:3},{id:"3-babel-\u662F\u5982\u4F55\u89E3\u6790-jsx-\u7684",text:"3. Babel \u662F\u5982\u4F55\u89E3\u6790 JSX \u7684\uFF1F",depth:2}],S="\u8BA4\u8BC6 JSX";function D(s){const l=Object.assign({h1:"h1",a:"a",h2:"h2",ul:"ul",li:"li",p:"p",div:"div",button:"button",span:"span",pre:"pre",code:"code",h3:"h3",img:"img",h4:"h4",ol:"ol"},s.components);return n(E,{children:[n(l.h1,{id:"\u8BA4\u8BC6-jsx",children:[e(l.a,{className:"header-anchor","aria-hidden":"true",href:"#\u8BA4\u8BC6-jsx",children:"#"}),"\u8BA4\u8BC6 JSX"]}),`
...
`,e(l.span,{className:"line",children:e(l.span,{style:{color:"#d8dee9ff"}})})]})})]}),`
`]}),`
`]})]})}function j(s={}){const{wrapper:l}=s.components||{};return l?e(l,Object.assign({},s,{children:e(D,s)})):D(s)}const w="2022/11/25 13:07:51",P=`import { DemoBlock } from '@island/demo-block'
...
- React Automatic Runtime
  ...
  \`\`\`
`;export{P as content,j as default,x as frontmatter,w as lastUpdatedTime,S as title,R as toc};
