var A=Object.defineProperty;var u=(s,l,r)=>l in s?A(s,l,{enumerable:!0,configurable:!0,writable:!0,value:r}):s[l]=r;var m=(s,l,r)=>(u(s,typeof l!="symbol"?l+"":l,r),r);import{jsxs as e,jsx as n,Fragment as g}from"react/jsx-runtime";import{D as h}from"./index.6529e49c.js";import p,{forwardRef as f,useState as I,useImperativeHandle as v,useRef as R}from"react";class P extends p.Component{constructor(){super(...arguments);m(this,"state",{message:"Hello React"})}handleChange(r){this.setState({message:r})}render(){return e("div",{children:[n(b,{message:this.state.message}),n("input",{type:"text",onChange:r=>this.handleChange(r.target.value)})]})}}class b extends p.Component{componentWillReceiveProps(l){console.log("[PropsDemo1Child] nextProps:",l)}render(){return n("div",{children:n("p",{children:this.props.message})})}}const D=s=>({log:(r,...a)=>console.log(`[${s}]`,r,...a)}),x=D("InjectPropsDemo1"),k=()=>n(S,{children:n(j,{name:"plasticine",age:"21"})}),S=s=>s.children,j=s=>(x.log("props:",s),n("div",{children:"child"})),w=D("InjectPropsDemo2"),W=()=>n(V,{children:n(_,{name:"plasticine",age:"21"})}),V=s=>p.cloneElement(s.children,{injectedProp:"hello"}),_=s=>(w.log("props:",s),n("div",{children:"child"})),L="_form_qirhu_1",H={form:L},$=f((s,l)=>{const[r,a]=I({}),o={setFormItemValue(c,i){a(d=>({...d,[c]:i}))},submit(c){c(r)},reset(){a(c=>{const i={};for(const d of Object.keys(c))i[d]="";return i})}};v(l,()=>o);const t=(c,i)=>{a(d=>{const C={...d};return C[c]=i,C})},E=[];return p.Children.forEach(s.children,c=>{if(p.isValidElement(c)&&c.type.displayName==="FormItem"){const{name:i}=c.props,d=p.cloneElement(c,{key:i,value:r[i]||"",label:i,onChange:t},c.props.children);E.push(d)}}),n("div",{className:H.form,children:E})}),G="_form-item_2s78b_1",O={formItem:G},F=s=>{const{name:l,value:r,label:a,children:o}=s,{onChange:t}=s,E=c=>{t&&t(l,c)};return e("div",{className:O.formItem,children:[n("label",{htmlFor:l,children:a}),p.isValidElement(o)&&o.type.displayName==="Input"?p.cloneElement(o,{value:r,onChange:E}):""]})};F.displayName="FormItem";const y=s=>{const{value:l}=s,{onChange:r}=s;return n("input",{type:"text",value:l,onChange:a=>r&&r(a.target.value)})};y.displayName="Input";const Y="_container_fmjh6_1",M="_button-group_fmjh6_7",B={container:Y,buttonGroup:M},T=D("PropsPracticalDemo"),X=()=>{const s=R(null),l=()=>{var o;(o=s.current)==null||o.submit(t=>{T.log(t)})},r=()=>{var o;(o=s.current)==null||o.reset()},a=()=>{var o,t;(o=s.current)==null||o.setFormItemValue("username","plasticine"),(t=s.current)==null||t.setFormItemValue("password","123456")};return e("div",{className:B.container,children:[e($,{ref:s,children:[n("div",{children:"I will be ignored."}),n(F,{name:"username",children:n(y,{})}),n(F,{name:"password",children:n(y,{})}),n(F,{name:"ignored",children:n("div",{children:"I will be ignored."})})]}),e("section",{className:B.buttonGroup,children:[n("button",{onClick:()=>l(),children:"\u63D0\u4EA4"}),n("button",{onClick:()=>r(),children:"\u91CD\u7F6E"}),n("button",{onClick:()=>a(),children:"\u751F\u6210\u8868\u5355\u6A21\u677F\u6570\u636E"})]})]})},K=void 0,Q=[{id:"1-\u76D1\u542C-props-\u53D8\u5316",text:"1. \u76D1\u542C props \u53D8\u5316",depth:2},{id:"11-\u7C7B\u7EC4\u4EF6\u4E2D",text:"1.1. \u7C7B\u7EC4\u4EF6\u4E2D",depth:3},{id:"12-\u51FD\u6570\u7EC4\u4EF6\u4E2D",text:"1.2. \u51FD\u6570\u7EC4\u4EF6\u4E2D",depth:3},{id:"2-\u6CE8\u5165-props",text:"2. \u6CE8\u5165 props",depth:2},{id:"21-\u663E\u5F0F\u6CE8\u5165",text:"2.1. \u663E\u5F0F\u6CE8\u5165",depth:3},{id:"22-\u9690\u5F0F\u6CE8\u5165-props",text:"2.2. \u9690\u5F0F\u6CE8\u5165 props",depth:3},{id:"3-\u5B9E\u6218----form-\u548C-formitem",text:"3. \u5B9E\u6218 -- Form \u548C FormItem",depth:2},{id:"31-\u9700\u6C42\u5206\u6790",text:"3.1. \u9700\u6C42\u5206\u6790",depth:3},{id:"32-\u4F7F\u7528\u6848\u4F8B",text:"3.2. \u4F7F\u7528\u6848\u4F8B",depth:3},{id:"33-\u5B9E\u73B0",text:"3.3 \u5B9E\u73B0",depth:3},{id:"331-form-\u7EC4\u4EF6",text:"3.3.1 Form \u7EC4\u4EF6",depth:4},{id:"332-formitem-\u7EC4\u4EF6",text:"3.3.2 FormItem \u7EC4\u4EF6",depth:4},{id:"333-input-\u7EC4\u4EF6",text:"3.3.3 Input \u7EC4\u4EF6",depth:4}],Z="\u6DF1\u5165 Props";function N(s){const l=Object.assign({h1:"h1",a:"a",h2:"h2",h3:"h3",p:"p",code:"code",div:"div",button:"button",span:"span",pre:"pre",img:"img",ol:"ol",li:"li",h4:"h4"},s.components);return e(g,{children:[e(l.h1,{id:"\u6DF1\u5165-props",children:[n(l.a,{className:"header-anchor","aria-hidden":"true",href:"#\u6DF1\u5165-props",children:"#"}),"\u6DF1\u5165 Props"]}),`
...
`,n(l.span,{className:"line"})]})})]}),`
`,n(h,{children:n(X,{})})]})}function ll(s={}){const{wrapper:l}=s.components||{};return l?n(l,Object.assign({},s,{children:n(N,s)})):N(s)}const nl="2022/11/30 08:38:59",el=`import { DemoBlock } from '@island/demo-block'
...
`;export{el as content,ll as default,K as frontmatter,nl as lastUpdatedTime,Z as title,Q as toc};
